...
web_crawler = db.get_collection("web_crawler_multithreaded")
...
def crawl():
    while True and len(visited) < 1000:
        url = None
        with q_lock:
            if len(q) > 0:
                url = q.pop(0)
...
def main():
    ...
    print("Total time of execution (s): ", s)
